...
public class StaticValue {
    ...
    //文字
    public static BufferedImage line1 = null;
    public static BufferedImage line2 = null;
    //障碍物
    ...
    public static void init(){
        try {
            ...
            line1=ImageIO.read(new File(path+"line1.png"));
            line2=ImageIO.read(new File(path+"line2.png"));
